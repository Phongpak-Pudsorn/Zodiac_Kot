...
class NoticeAdsListView @JvmOverloads constructor(
            ...
            if(adsModel.Status == "True") {
                ...
                try {
                    ...
                    if (dataRowPublish[0].Publishtitle == ""){
                        ...
                        bindingListview.mTvTextNoticeMessage.adapter = AdapterNotice(dataRowPublish)
    ...
    inner class AdapterNotice(private val dataJson : ArrayList<AdsModel.Datapublish>) : BaseAdapter() {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            try {
                ...
                bindingNoticeItem.mTvReadMore.setOnClickListener {
                    ...
                    if (dataJson[position].Publishtype == "LinkToURL"){
